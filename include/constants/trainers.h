...
#define TRAINER_PIC_FROMUNDA_MAN          93
#define TRAINER_PIC_CHLOE_VASILIOU        94
#define TRAINER_PIC_NICK_PEACE            95
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_FROMUNDA_MAN,
    TRAINER_CLASS_NTARAS_DAWN,
    TRAINER_CLASS_COUNT,
};
