...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_CHLOE_VASILIOU] = REMATCH(TRAINER_CHLOE_VASILIOU_1, TRAINER_CHLOE_VASILIOU_2, TRAINER_CHLOE_VASILIOU_3, TRAINER_CHLOE_VASILIOU_4, TRAINER_CHLOE_VASILIOU_5, ROUTE119),
    ...
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_3, TRAINER_BRAWLY_3, DEWFORD_TOWN),
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_4, PETALBURG_CITY),
