...
#endif //P_HISUIAN_FORMS
#if P_CUSTOM_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(CyndaquilDelta);
PLACEHOLDER_ANIM_SINGLE_FRAME(QuilavaDelta);
PLACEHOLDER_ANIM_SINGLE_FRAME(TyphlosionDelta);
...
#endif //P_MEGA_EVOLUTIONS
#if P_CUSTOM_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(BunearyKuria);
PLACEHOLDER_ANIM_SINGLE_FRAME(LopunnyKuria);
#if P_MEGA_EVOLUTIONS
PLACEHOLDER_ANIM_SINGLE_FRAME(LopunnyKuriaMega);
#endif //P_MEGA_EVOLUTIONS
#endif //P_CUSTOM_FORMS
...
#endif //P_MEGA_EVOLUTIONS
#if P_CUSTOM_FORMS
SINGLE_ANIMATION(BunearyKuria);
SINGLE_ANIMATION(LopunnyKuria);
#if P_MEGA_EVOLUTIONS
SINGLE_ANIMATION(LopunnyKuriaMega);
#endif //P_MEGA_EVOLUTIONS
#endif //P_CUSTOM_FORMS
#endif //P_FAMILY_BUNEARY
#if P_FAMILY_GLAMEOW
