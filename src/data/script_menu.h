...
{
    {COMPOUND_STRING("TREECKO DOLL 100 COINS")},
    {COMPOUND_STRING("TORCHIC DOLL 100 COINS")},
    {COMPOUND_STRING("MUDKIP DOLL   100 COINS")},
    {gText_Exit},
};

static const struct MenuAction MultichoiceList_GameCornerTMs[] =
{
    {COMPOUND_STRING("TM32{CLEAR_TO 0x48}800 COINS")},
    {COMPOUND_STRING("TM29{CLEAR_TO 0x48}1,00 COINS")},
    {COMPOUND_STRING("TM35{CLEAR_TO 0x48}1,000 COINS")},
    {COMPOUND_STRING("TM24{CLEAR_TO 0x48}1,000 COINS")},
    {COMPOUND_STRING("TM13{CLEAR_TO 0x48}1,000 COINS")},
    {gText_Exit},
};
